class Post
  ...
  attr_accessor :id, :title, :body, :author, :created_at, :author_picture, :post_picture
  ...
  def initialize(args)
    ...
    self.author_picture = args[:author_picture]
    self.post_picture = args[:post_picture]
  end
    ...
    unless defined?(@posts)
      @posts = [
        ...
        Post.new(
          ...
          author: "Mark Twain",
          author_picture: "mark_twain",
          post_picture: "longhorn",
          body: %q(
        ...
        Post.new(
          ...
          author_picture: "conan_doyle",
          post_picture: "water_buffalo",
          body: %q(
            Two men were travelling together, one of whom never spoke the truth, whereas the other never told a lie: and they came in the course of their travels to the land of Apes.
        ...
        Post.new(
          ...
          author_picture: "stanley_kubrick",
          post_picture: "zebu",
          body: %q(
            Two men were travelling together, one of whom never spoke the truth, whereas the other never told a lie: and they came in the course of their travels to the land of Apes.
